...
import { signInSchema } from '@solvesphere/shared';
    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/30 px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-muted-foreground">Sign in to SolveSphere AI</p>
        </div>

        <div className="rounded-2xl border bg-card p-8 shadow-sm">
          <button
            onClick={handleGoogleSignIn}
            className="mb-6 flex w-full items-center justify-center gap-3 rounded-lg border py-3 text-sm font-medium hover:bg-muted transition-colors"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border bg-background px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500"
